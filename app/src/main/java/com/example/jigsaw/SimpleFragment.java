...
public class SimpleFragment extends Fragment{
    ...
    private TextView tv ;
    private ImageView image01,image02,image03,image04,image05,image06,image07,image08,image09;
    private ImageView blankImage ;
    private ImageView[] imageV ;
    private Button reStart ;
    private Button tip;
    private int time = 0 ;
    private int blankPosition = 8;//空白图片的位置 第一个位置下标为0 ，九张图片， 最后一个位置下标为8
    private int blankImageId = R.id.image09;//空白图片的id;
    private int[] imageD={R.drawable.simple_01 , R.drawable.simple_02 , R.drawable.simple_03,
            R.drawable.simple_04 , R.drawable.simple_05 , R.drawable.simple_06,
            R.drawable.simple_07 , R.drawable.simple_08 , R.drawable.simple_09,
    };
    //用于监听事件
    private int[] imageId={
            R.id.image01 , R.id.image02 , R.id.image03, R.id.image04 , R.id.image05 , R.id.image06,
            R.id.image07 , R.id.image08 , R.id.image09
    };
    myArray myarray = new myArray(3 ) ;
    //private int[] imageIndex = new int[imageD.length];
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        tv = (TextView) getActivity().findViewById(R.id.tv);
        blankImageId = R.drawable.difficult_09;
        handler.sendEmptyMessageDelayed(1 , 1000);
        myarray.initArray();
        //初始化控件
        initImage();
    ...
    public void reStart() {
        ...
        //设置空白图片以及位置
        blankPosition = 8;
        blankImage = (ImageView) getActivity().findViewById(R.id.image09);
        blankImageId = R.id.image09;
